    ...
    return (
        <div className="h-full flex justify-between items-center px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 text-2xl">
            ...
            <div className="md:hidden">
                ...
                {/*menu list*/}
                {open && (
                <motion.div variants={listVariants} initial="closed" animate={open ? "opened" : "closed"} exit="closed" className="absolute top-0 right-0 w-full h-screen bg-black text-white flex flex-col items-center justify-center gap-8 text-4xl z-40">
                     {links.map((link) => (
