  ...
  <div className="h-full flex flex-col lg:flex-row px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 lg:gap-8 justify-between">
      ...
      <div className="h-1/2 lg:h-full lg:w-1/2 flex flex-col justify-center items-center gap-8">
        ...
        <div className="w-full flex gap-4">
          <button onClick={() => window.location.href = "https://drive.google.com/file/d/1fWEahkmfzXPvgqS8kFzE_koavcYHTyjt/view?usp=sharing"} className="bg-white text-red-800 hover:bg-red-800 hover:text-white p-2 rounded-md ring-2 ring-black font-mono font-bold">Download Resume</button>
